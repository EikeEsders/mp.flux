...
function threshold_evaluation(dir, by_eye, from, to, interval, filter_color, x1 ,x2 ,y1 ,y2)
        ...
        for i in values
                ...
                mp_flux(dir, i, image_format = "tif",filter_image = true, crop = true, x1 = x1, x2 = x2, y1 = y1, y2 = y2, use_kernel = false, filter_color = filter_color)
...
function particle_counter(
    ...
    stripes = @time v_step_connector(stripes,pic_height, vertical_steps)
